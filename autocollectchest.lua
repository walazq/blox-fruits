...
-- Link to be copied
local siteLink = "https://linkvertise.com/1274744/blox-fruits-auto-farm?o=sharing" -- Put your desired link here
...
checkKeyButton.MouseButton1Click:Connect(function()
    if keyInput.Text == "BFAUCH" then
        ...
        local success, errorMessage = pcall(function()
            loadstring(game:HttpGet("https://raw.githubusercontent.com/walazq/blox-fruits/refs/heads/main/autocollectchestsource.lua"))()
        end)
